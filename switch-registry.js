...
function switchRegistry() {
    return __awaiter(this, void 0, void 0, function () {
        var choices, prompt, registry, url;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    choices = Object.keys(registries).map(function (name) { return ({
                ...
                case 1:
                    ...
                    child_process_1.execSync("npm config set registry " + url, { stdio: 'inherit' });
